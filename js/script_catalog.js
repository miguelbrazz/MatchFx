const API_KEY = 'api_key=28b070fb920a8ed2cc611bebf038d3fb';
...
function clearBtn(){
    ...
    if(clearBtn) {
        ...
        clear.id = 'clear';
        clear.innerText = 'Clear Selections';
    ...
    lastUrl = url;
        fetch(url).then(res => res.json()).then(data => {
            ...
            if(data.results.length !== 0){
                ...
                main.innerHTML= `<h1 class="no-results">No Results Found</
                h1>`
            }
        })
}
...
function showMovies(data) {
    ...
    data.forEach(movie => {
        ...
        movieEl.innerHTML = `
        <img src="${poster_path? IMG_URL+poster_path: "http://via.placeholder.com/1080x1580" }" 
        alt="${title}">
